...
void download_log(){
    char i=0;
    char data[15];
    clcd_print(" Downloaded Log ",(0x80 + (0)));
    clcd_print("  Successfully  ",(0xC0 + (0)));
