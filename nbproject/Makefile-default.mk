...
SOURCEFILES_QUOTED_IF_SPACED=clcd.c main.c mkp.c dashboard.c adc.c eeprom.c ds1307.c ext_eeprom.c i2c.c log.c uart.c menu.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/mkp.p1 ${OBJECTDIR}/dashboard.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/ext_eeprom.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/log.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/menu.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/clcd.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/mkp.p1.d ${OBJECTDIR}/dashboard.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/ds1307.p1.d ${OBJECTDIR}/ext_eeprom.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/log.p1.d ${OBJECTDIR}/uart.p1.d ${OBJECTDIR}/menu.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/clcd.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/mkp.p1 ${OBJECTDIR}/dashboard.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/ds1307.p1 ${OBJECTDIR}/ext_eeprom.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/log.p1 ${OBJECTDIR}/uart.p1 ${OBJECTDIR}/menu.p1

# Source Files
SOURCEFILES=clcd.c main.c mkp.c dashboard.c adc.c eeprom.c ds1307.c ext_eeprom.c i2c.c log.c uart.c menu.c
...
${OBJECTDIR}/log.p1: log.c  nbproject/Makefile-${CND_CONF}.mk 
	...
	@${RM} ${OBJECTDIR}/log.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/log.p1 log.c 
...
${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/CAR_BLACK_BOX.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
